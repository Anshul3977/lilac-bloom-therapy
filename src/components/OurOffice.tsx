 ...
 import office1Image from "@/assets/office1.jpeg";
 import office2Image from "@/assets/office2.jpeg";
         ...
         <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
           ...
           >
             <div className="grid grid-cols-5 gap-4">
               {/* Large image */}
               <div className="col-span-3 aspect-[4/5] overflow-hidden rounded-lg">
                 <img
                   src={office1Image}
               ...
               <div className="col-span-2 aspect-[4/5] overflow-hidden rounded-lg mt-12">
                 <img
                   src={office2Image}
