...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-light-tan">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div>
                  ...
                  <Input
                    id="name"
                    {...register("name")}
                    className="mt-2 bg-white border-border focus:border-olive focus:ring-olive"
                ...
                <div>
                  ...
                  <Textarea
                    id="message"
                    {...register("message")}
                    className="mt-2 bg-white border-border focus:border-olive focus:ring-olive min-h-[150px]"
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full rounded-full py-6 border-2 border-text-dark text-text-dark hover:bg-card uppercase tracking-widest text-xs md:text-sm font-medium"
                >
            ...
            >
              ...
              <div className="space-y-6 mb-12">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-light-lilac flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 text-olive" />
                  </div>
                  <div>
                    <h3 className="font-medium text-text-dark mb-1">Phone</h3>
                    <p className="text-text-medium font-light">(555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-medium font-light">hello@lilactherapy.com</p>
                  </div>
                </div>
              ...
              {/* Map placeholder */}
              <div className="aspect-video bg-light-tan rounded-lg overflow-hidden">
                <img
